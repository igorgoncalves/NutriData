...
def OrganizerSheet(planilha, nome_macroindicador, descricao_macroindicador, anos):
    schema_amostra = AmostraSchema()
    ...
    for header in indicadores:
        indicador = {}
        coluna = indicadores.index(header)
        ...
        for ano in range (0, amostras_ano):
            for territorio in valores[ano]:
                    ...
                    amostra_obj['codigo_localidade'] = local_id
                    ...
                    if valor_amostral != '-' and valor_amostral != None and valor_amostral != 0 and valor_amostral != "...":                    
                        try:            
                            result = schema_amostra.load(amostra_obj)
                            print(result)
